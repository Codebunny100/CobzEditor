...
class TextEditor:
    ...
    def _build_ui(self) -> None:
        ...
        self.text_area.config(xscrollcommand=None if self.wrap_enabled else self.scroll_x.set)
    ...
    def toggle_wrap(self) -> None:
        ...
        if self.wrap_enabled:
            self.text_area.config(wrap="char", xscrollcommand=None)
            self.scroll_x.pack_forget()
        else:
            self.text_area.config(wrap="none", xscrollcommand=self.scroll_x.set)
            self.scroll_x.pack(fill="x", before=self.status_bar)
